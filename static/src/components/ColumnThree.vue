<template>
    <div>
        <col-head :product="'ETH/BTC'" :trades="trades"></col-head>
...
export default {
    computed: {
        product() {
            return this.$store.state.products[2].name
        },
        book() {
            return this.$store.state.products[2].book
        },
        trades() {
            return this.$store.state.products[2].trades
        }
    },
    components: {
        ColHead,
